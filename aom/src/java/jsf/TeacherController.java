...
import jpa.session.TeacherFacade;
...
public class TeacherController implements Serializable {
    ...
    @EJB
    private jpa.session.TeacherFacade ejbFacade;
    ...
    public String create() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("re/Bundle").getString("TeacherCreated"));
    ...
    public String update() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("re/Bundle").getString("TeacherUpdated"));
            return "View";
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("re/Bundle").getString("PersistenceErrorOccured"));
            return null;
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("re/Bundle").getString("TeacherDeleted"));
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("re/Bundle").getString("PersistenceErrorOccured"));
        }
    }
